...
export class Backend implements backendInterface {
    ...
    async addMovie(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: ExternalBlob, arg5: ExternalBlob): Promise<MovieId> {
        if (this.processError) {
            try {
                const result = await this.actor.addMovie(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMoviesByGenre(arg0: string): Promise<Array<Movie>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMoviesByGenre(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Movie_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Movie): Promise<Movie> {
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "tollywood" in value ? Genre.tollywood : "hollywood" in value ? Genre.hollywood : "bollywood" in value ? Genre.bollywood : "gujarati" in value ? Genre.gujarati : value;
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Movie>): Promise<Array<Movie>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Movie_n12(_uploadFile, _downloadFile, x)));
}
